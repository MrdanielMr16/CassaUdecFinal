...
public class UsuarioController {
    ...
    public void loginPageRedirect(HttpServletRequest request, HttpServletResponse response, Authentication authResult) throws IOException, ServletException {
        ...
        if(roles.contains("ADMIN")){
         response.sendRedirect(response.encodeRedirectURL(request.getContextPath() + "/FormUsuario"));                            
         }
	...
	public String PaginaDeMultimedia() {
		return "User/Multimedia";
	}
	
	@GetMapping("/Chat")
	public String PaginaDeChat() {
		return "Admin/Chat";
	}
	
	@GetMapping("/ChatUser")
	public String PaginaDeChatUser() {
		return "User/ChatUser";
	}
	
	@GetMapping("/Noticias")
	public String PaginaDeNoticias() {
		return "User/Noticias";
	}
	@GetMapping("/signup")

...
public class EventosController {
	...
	public String save(@RequestParam("file") MultipartFile file,@Valid Eventos eventos,BindingResult bindingResult, Model model) {
		...
		if (!file.isEmpty()) {
			String ruta = "C://Users//dapip//Prueba1";
			try {
				byte[] bytesimg = file.getBytes();
				Path rutaCompleta = Paths.get(ruta + "//" + file.getOriginalFilename());
